...
@section('title', 'Add Investigation Officer')
...
<div class="page-header animate-fade-up">
  <div class="page-title-group">
    ...
    <h1 class="page-title">Add Investigation Officer</h1>
    <p class="page-subtitle">Enter IO details</p>
...
<form method="POST" action="{{ route('investigation-officers.store') }}" class="form-standard">
  @csrf
    ...
    <div class="cf-body">
      <div class="cf-row-2">
        <div class="cf-field">
          ...
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="name" value="{{ old('name') }}" required>
          </div>
        </div>
        <div class="cf-field">
          <label class="cf-label required">Badge No.</label>
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="badge_no" value="{{ old('badge_no') }}" required>
          </div>
        </div>
      </div>
      ...
      <div class="cf-row-2">
        <div class="cf-field">
          ...
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="designation" value="{{ old('designation') }}">
          </div>
        </div>
        <div class="cf-field">
          <label class="cf-label">Date of Joining</label>
          <div class="cf-input-wrap">
            <input type="date" class="cf-input" name="date_of_joining" value="{{ old('date_of_joining') }}">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cf-body">
      <div class="cf-row-2">
        <div class="cf-field">
          ...
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="circle" value="{{ old('circle') }}">
          </div>
        </div>
        <div class="cf-field">
          <label class="cf-label">Zone</label>
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="zone" value="{{ old('zone') }}">
          </div>
        </div>
      </div>
      ...
      <div class="cf-row-2">
        <div class="cf-field">
          ...
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="contact_no" value="{{ old('contact_no') }}">
          </div>
        </div>
        <div class="cf-field">
          <label class="cf-label">Email</label>
          <div class="cf-input-wrap">
            <input type="email" class="cf-input" name="email" value="{{ old('email') }}">
          </div>
        </div>
      </div>
      ...
      <div class="cf-field">
        ...
        <div class="cf-input-wrap">
          <textarea class="cf-input cf-textarea" name="address" rows="2">{{ old('address') }}</textarea>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="cf-section animate-fade-up animate-delay-3">
    ...
    <div class="cf-body">
        ...
        <div class="cf-field">
          ...
          <div class="eq-select-wrap" id="sel_status">
            <button type="button" class="eq-select-btn" data-placeholder="— Select Status —">
              <span class="eq-select-val chosen">Active</span>
            ...
            <div class="eq-select-dropdown">
              <div class="eq-options">
                <div class="eq-option active" data-value="active">Active</div>
                <div class="eq-option" data-value="inactive">Inactive</div>
              </div>
            </div>
      ...
      <div class="cf-field">
        ...
        <div class="cf-input-wrap">
          <textarea class="cf-input cf-textarea" name="remarks" rows="3">{{ old('remarks') }}</textarea>
        </div>
      </div>
    </div>
  </div>
