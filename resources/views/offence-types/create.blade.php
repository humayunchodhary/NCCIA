...
<div class="page-header animate-fade-up">
  <div class="page-title-group">
    ...
    <h1 class="page-title">Add Crime Category</h1>
    <p class="page-subtitle">Create a new offence type</p>
...
<form method="POST" action="{{ route('offence-types.store') }}" class="form-standard">
  @csrf
  ...
  <div class="cf-section animate-fade-up animate-delay-1">
    <div class="cf-section-header">
      ...
      <div>
        ...
        <div class="cf-section-sub">Enter the crime category information</div>
      </div>
    </div>
    <div class="cf-body">
      <div class="cf-row-2">
        <div class="cf-field">
          ...
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="name" value="{{ old('name') }}" placeholder="e.g. Cyber Stalking (Section 414 PPC)" required>
          </div>
        </div>
        <div class="cf-field">
          <label class="cf-label required">Value</label>
          <div class="cf-input-wrap">
            <input type="text" class="cf-input" name="value" value="{{ old('value') }}" placeholder="e.g. cyberstalking" required>
          </div>
        </div>
      </div>
      ...
      <div class="cf-field">
        ...
        <div class="cf-input-wrap">
          <input type="text" class="cf-input" name="group" value="{{ old('group') }}" placeholder="e.g. Financial Crimes, Privacy & Harassment, Technical Crimes">
        </div>
      </div>
    </div>
  </div>
