...
class NcciaOfficesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $officialCircles = [
            ...
            // Khyber Pakhtunkhwa (KPK) Regional Offices
            [
                'code' => 'PEW',
                'name' => 'NCCIA Peshawar',
                'zone_id' => $zoneKpk->id,
