...
class ReferenceDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Sop::insert([
            ...
            ['title' => 'Inter-Agency Coordination & Information Sharing', 'department' => 'Administration', 'version' => '1.0', 'effective_date' => '2024-07-01', 'description' => 'Guidelines for secure information exchange with NCCIA, police, banks, telecom operators, and international agencies.', 'created_at' => now(), 'updated_at' => now()],
        ]);
