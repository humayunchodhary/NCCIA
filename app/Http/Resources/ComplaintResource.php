...
class ComplaintResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'cnic_back_url'        => $this->cnic_back ? url($this->cnic_back) : null,
            'passport_attachment'  => $this->passport_attachment,
            'passport_attachment_url' => $this->passport_attachment ? url($this->passport_attachment) : null,
            'picture'              => $this->picture,
            'picture_url'          => $this->picture ? url($this->picture) : null,
